...
Route::get('/cron/generate-monthly-passes', [CronController::class, 'generateMonthlyPasses'])->name('cron.generate-monthly-passes');
...
Route::middleware(['auth', 'role:admin,reception'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::patch('/payments/{payment}/pay', [PaymentController::class, 'markPaid'])->name('payments.pay');
