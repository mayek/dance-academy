...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full space-y-8 p-8">
        <div class="text-center">
            <h1 class="text-3xl font-bold text-purple-700">Dance Academy</h1>
            <p class="mt-2 text-gray-600">Create a new student account</p>
        </div>
        <div class="bg-white rounded-lg shadow p-8">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                        <label for="parent_phone_number" class="block text-sm font-medium text-gray-700">Parent phone</label>
