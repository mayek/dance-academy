            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm space-x-2">
                        <a href="{{ route('teacher.events.assign', $event) }}" class="text-indigo-600 hover:text-indigo-800">{{ __('Assign') }}</a>
                        <a href="{{ route('teacher.events.edit', $event) }}" class="text-emerald-600 hover:text-emerald-800">{{ __('Edit') }}</a>
