...
<div class="px-4 sm:px-0 max-w-2xl">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('admin.events.update-students', $event) }}">
            @csrf @method('PUT')
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('admin.events.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-4 rounded-lg">{{ __('Cancel') }}</a>
            </div>
        </form>
    </div>
</div>
