@extends('layouts.app')
@section('title', 'Edit Dance Group')

@section('content')
<div class="px-4 sm:px-0 max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Edit Dance Group</h1>
    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" action="{{ route('admin.groups.update', $group) }}">
            ...
            <div class="flex space-x-3">
                <button type="submit" class="bg-orange-600 hover:bg-orange-700 text-white font-medium py-2 px-4 rounded-lg">Update Group</button>
