...
<div class="px-4 sm:px-0">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="{{ route('admin.teachers.index') }}" class="mt-3 inline-block text-sm text-purple-600 hover:text-purple-800">Manage &rarr;</a>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="{{ route('admin.students.index') }}" class="mt-3 inline-block text-sm text-blue-600 hover:text-blue-800">Manage &rarr;</a>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="{{ route('admin.categories.index') }}" class="mt-3 inline-block text-sm text-green-600 hover:text-green-800">Manage &rarr;</a>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            <div class="text-sm font-medium text-gray-500">Dance Groups</div>
            <div class="mt-1 text-3xl font-bold text-orange-600">{{ $stats['groups'] }}</div>
            <a href="{{ route('admin.groups.index') }}" class="mt-3 inline-block text-sm text-orange-600 hover:text-orange-800">Manage &rarr;</a>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="{{ route('admin.payments.index') }}" class="mt-3 inline-block text-sm text-emerald-600 hover:text-emerald-800">View &rarr;</a>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <a href="{{ route('admin.payments.index') }}" class="mt-3 inline-block text-sm text-indigo-600 hover:text-indigo-800">View &rarr;</a>
        </div>
    </div>
