        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr wire:key="group-{{ $group->id }}">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-[240px] whitespace-normal break-words" title="{{ $group->schedule ?? '' }}">{{ $group->schedule ? \Illuminate\Support\Str::limit($group->schedule, 40) : '-' }}</td>
