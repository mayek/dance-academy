                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-4">
                        @if(auth()->user()->isAdmin())
                            ...
                            <a href="{{ route('admin.teachers.index') }}" class="inline-flex items-center px-1 pt-1 text-sm font-medium {{ request()->routeIs('admin.teachers.*') ? 'text-gray-900 underline' : 'text-gray-500 hover:text-gray-900' }}">{{ __('Teachers') }}</a>
